# -*- coding: utf-8 -*-
"""
Created on Mon Jul 31 20:32:30 2023
...
# %% Read datasets
# Get two annotators
y_cardiologist1 = pd.read_csv("C:\\Users\\atrij\OneDrive\Desktop\DeepLearning\ECG\data\data\\annotations\cardiologist1.csv").values
y_cardiologist2 = pd.read_csv("C:\\Users\\atrij\OneDrive\Desktop\DeepLearning\ECG\data\data\\annotations\cardiologist2.csv").values
# Get true values
y_true = pd.read_csv("C:\\Users\\atrij\OneDrive\Desktop\DeepLearning\ECG\data\data\\annotations\gold_standard.csv").values
# Get residents and students performance
y_cardio = pd.read_csv("C:\\Users\\atrij\OneDrive\Desktop\DeepLearning\ECG\data\data\\annotations\cardiology_residents.csv").values
y_emerg = pd.read_csv("C:\\Users\\atrij\OneDrive\Desktop\DeepLearning\ECG\data\data\\annotations\emergency_residents.csv").values
y_student = pd.read_csv("C:\\Users\\atrij\OneDrive\Desktop\DeepLearning\ECG\data\data\\annotations\medical_students.csv").values
# get y_score for different models
y_score_list = [np.load("C:\\Users\\atrij\OneDrive\Desktop\DeepLearning\ECG\dnn_output" + '.npy') for i in range(1)]
